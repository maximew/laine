...
class AgendasControllerTest < ActionController::TestCase
  ...
  test "should create agenda" do
    assert_difference('Agenda.count') do
      post :create, agenda: { content: @agenda.content, enddate: @agenda.enddate, startdate: @agenda.startdate, title: @agenda.title }
    end
  ...
  test "should update agenda" do
    patch :update, id: @agenda, agenda: { content: @agenda.content, enddate: @agenda.enddate, startdate: @agenda.startdate, title: @agenda.title }
    assert_redirected_to agenda_path(assigns(:agenda))
  end
